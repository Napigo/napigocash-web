    ...
    return (
        <div className="flex flex-col">
            <header className="relative w-screen h-auto flex flex-col lg:flex-row items-center justify-center">
                ...
                <div className="w-full h-full z-50 px-5 lg:px-20 flex flex-col lg:flex-row justify-between items-start text-center lg:text-left  pb-10">
                        ...
                        <div className="flex flex-col">
                            ...
                            {!showLargePhone && (
                                <div className="w-full lg:w-1/2 h-auto flex justify-center items-center pt-[100px] lg:pt-[250px]">
                                    <Image src="/header-phone.svg" alt="header-phone" width={827} height={805} />
                                </div>
                            )}
                        </div>
            ...
            <div className="flex flex-row items-center w-full justify-center pl-20 pr-20">
                <div className="h-[2px] w-[50%] bg-paper_1 mr-5" />
                <Image alt="divider" src="/divider.svg" height={25} width={35} />
                <div className="h-[2px] w-[50%] bg-paper_1 ml-5" />
            </div>
        </div>
    );
};
